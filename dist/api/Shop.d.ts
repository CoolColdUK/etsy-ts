import { IFindShopsParams, IShop, IShops, IUpdateShopPayload } from "./data-contracts";
...
export declare class Shop {
     ...
     */
    getShop: (shopId: number, params?: RequestParams) => Promise<import("axios").AxiosResponse<IShop, any>>;
    /**
     ...
     * @response `500` `IErrorSchema` The server encountered an internal error. See the error message for details.
     */
    updateShop: (shopId: number, data: IUpdateShopPayload, params?: RequestParams) => Promise<import("axios").AxiosResponse<IShop, any>>;
    /**
     ...
     * @response `500` `IErrorSchema` The server encountered an internal error. See the error message for details.
     */
    getShopByOwnerUserId: (userId: number, params?: RequestParams) => Promise<import("axios").AxiosResponse<IShop, any>>;
    /**
     ...
     * @response `500` `IErrorSchema` The server encountered an internal error. See the error message for details.
     */
    findShops: (query: IFindShopsParams, params?: RequestParams) => Promise<import("axios").AxiosResponse<IShops, any>>;
}
