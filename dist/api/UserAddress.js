...
var UserAddress = /** @class */ (function () {
    function UserAddress(http) {
         ...
         */
        this.deleteUserAddress = function (userAddressId, params) {
            if (params === void 0) { params = {}; }
            return _this.http.request(tslib_1.__assign({ path: "/v3/application/user/addresses/".concat(userAddressId), method: "DELETE", secure: true }, params));
        };
        /**
         ...
         */
        this.getUserAddress = function (userAddressId, params) {
            if (params === void 0) { params = {}; }
            return _this.http.request(tslib_1.__assign({ path: "/v3/application/user/addresses/".concat(userAddressId), method: "GET", secure: true, format: "json" }, params));
        };
        /**
         ...
         * @response `500` `IErrorSchema` The server encountered an internal error. See the error message for details.
         */
        this.getUserAddresses = function (query, params) {
            if (params === void 0) { params = {}; }
            return _this.http.request(tslib_1.__assign({ path: "/v3/application/user/addresses", method: "GET", query: query, secure: true, format: "json" }, params));
        };
        this.http = http;
    }
    return UserAddress;
