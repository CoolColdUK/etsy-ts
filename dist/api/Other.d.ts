import { IPong, ITokenScopesPayload } from "./data-contracts";
...
export declare class Other {
     ...
     */
    ping: (params?: RequestParams) => Promise<import("axios").AxiosResponse<IPong, any>>;
    /**
     ...
     * @response `500` `IErrorSchema` The server encountered an internal error. See the error message for details.
     */
    tokenScopes: (data: ITokenScopesPayload, params?: RequestParams) => Promise<import("axios").AxiosResponse<object, any>>;
}
