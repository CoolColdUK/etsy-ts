import { IGetPaymentAccountLedgerEntryPaymentsParams, IGetPaymentsParams, IPayments } from "./data-contracts";
...
export declare class Payment {
     ...
     */
    getPaymentAccountLedgerEntryPayments: ({ shopId, ...query }: IGetPaymentAccountLedgerEntryPaymentsParams, params?: RequestParams) => Promise<import("axios").AxiosResponse<IPayments, any>>;
    /**
     ...
     * @response `500` `IErrorSchema` The server encountered an internal error. See the error message for details.
     */
    getShopPaymentByReceiptId: (shopId: number, receiptId: number, params?: RequestParams) => Promise<import("axios").AxiosResponse<IPayments, any>>;
    /**
     ...
     * @response `500` `IErrorSchema` The server encountered an internal error. See the error message for details.
     */
    getPayments: ({ shopId, ...query }: IGetPaymentsParams, params?: RequestParams) => Promise<import("axios").AxiosResponse<IPayments, any>>;
}
