import { IListingInventoryProduct } from "./data-contracts";
import { HttpClient, RequestParams } from "./http-client";
export declare class ShopListingProduct {
    http: HttpClient;
     ...
     */
    getListingProduct: (listingId: number, productId: number, params?: RequestParams) => Promise<import("axios").AxiosResponse<IListingInventoryProduct, any>>;
}
