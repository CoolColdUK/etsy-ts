import { ICreateShopSectionPayload, IShopSection, IShopSections, IUpdateShopSectionPayload } from "./data-contracts";
...
export declare class ShopSection {
     ...
     */
    createShopSection: (shopId: number, data: ICreateShopSectionPayload, params?: RequestParams) => Promise<import("axios").AxiosResponse<IShopSection, any>>;
    /**
     ...
     * @response `500` `IErrorSchema` The server encountered an internal error. See the error message for details.
     */
    getShopSections: (shopId: number, params?: RequestParams) => Promise<import("axios").AxiosResponse<IShopSections, any>>;
    /**
     ...
     * @response `503` `IErrorSchema` This function is temporarily unavailable. Please try again later.
     */
    deleteShopSection: (shopId: number, shopSectionId: number, params?: RequestParams) => Promise<import("axios").AxiosResponse<void, any>>;
    /**
     ...
     * @response `500` `IErrorSchema` The server encountered an internal error. See the error message for details.
     */
    getShopSection: (shopId: number, shopSectionId: number, params?: RequestParams) => Promise<import("axios").AxiosResponse<IShopSection, any>>;
    /**
     ...
     * @response `503` `IErrorSchema` This function is temporarily unavailable. Please try again later.
     */
    updateShopSection: (shopId: number, shopSectionId: number, data: IUpdateShopSectionPayload, params?: RequestParams) => Promise<import("axios").AxiosResponse<IShopSection, any>>;
}
