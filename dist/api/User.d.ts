import { ISelf, IUser } from "./data-contracts";
...
export declare class User {
     ...
     */
    getUser: (userId: number, params?: RequestParams) => Promise<import("axios").AxiosResponse<IUser, any>>;
    /**
     ...
     * @response `500` `IErrorSchema` The server encountered an internal error. See the error message for details.
     */
    getMe: (params?: RequestParams) => Promise<import("axios").AxiosResponse<ISelf, any>>;
}
