import { IConsolidateShopReturnPoliciesPayload, ICreateShopReturnPolicyPayload, IShopReturnPolicies, IShopReturnPolicy, IUpdateShopReturnPolicyPayload } from "./data-contracts";
import { HttpClient, RequestParams } from "./http-client";
export declare class ShopReturnPolicy {
    http: HttpClient;
     ...
     */
    consolidateShopReturnPolicies: (shopId: number, data: IConsolidateShopReturnPoliciesPayload, params?: RequestParams) => Promise<import("axios").AxiosResponse<IShopReturnPolicy, any>>;
    /**
     ...
     * @response `500` `IErrorSchema` The server encountered an internal error. See the error message for details.
     */
    createShopReturnPolicy: (shopId: number, data: ICreateShopReturnPolicyPayload, params?: RequestParams) => Promise<import("axios").AxiosResponse<IShopReturnPolicy, any>>;
    /**
     ...
     * @response `500` `IErrorSchema` The server encountered an internal error. See the error message for details.
     */
    getShopReturnPolicies: (shopId: number, params?: RequestParams) => Promise<import("axios").AxiosResponse<IShopReturnPolicies, any>>;
    /**
     ...
     * @response `500` `IErrorSchema` The server encountered an internal error. See the error message for details.
     */
    deleteShopReturnPolicy: (shopId: number, returnPolicyId: number, params?: RequestParams) => Promise<import("axios").AxiosResponse<void, any>>;
    /**
     ...
     * @response `500` `IErrorSchema` The server encountered an internal error. See the error message for details.
     */
    getShopReturnPolicy: (shopId: number, returnPolicyId: number, params?: RequestParams) => Promise<import("axios").AxiosResponse<IShopReturnPolicy, any>>;
    /**
     ...
     * @response `500` `IErrorSchema` The server encountered an internal error. See the error message for details.
     */
    updateShopReturnPolicy: (shopId: number, returnPolicyId: number, data: IUpdateShopReturnPolicyPayload, params?: RequestParams) => Promise<import("axios").AxiosResponse<IShopReturnPolicy, any>>;
}
