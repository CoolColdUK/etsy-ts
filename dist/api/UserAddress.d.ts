import { IGetUserAddressesParams, IUserAddress, IUserAddresses } from "./data-contracts";
...
export declare class UserAddress {
     ...
     */
    deleteUserAddress: (userAddressId: number, params?: RequestParams) => Promise<import("axios").AxiosResponse<void, any>>;
    /**
     ...
     */
    getUserAddress: (userAddressId: number, params?: RequestParams) => Promise<import("axios").AxiosResponse<IUserAddress, any>>;
    /**
     ...
     * @response `500` `IErrorSchema` The server encountered an internal error. See the error message for details.
     */
    getUserAddresses: (query: IGetUserAddressesParams, params?: RequestParams) => Promise<import("axios").AxiosResponse<IUserAddresses, any>>;
}
