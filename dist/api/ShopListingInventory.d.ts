import { IGetListingInventoryParams, IListingInventory, IListingInventoryWithAssociations, IUpdateListingInventoryPayload } from "./data-contracts";
import { HttpClient, RequestParams } from "./http-client";
export declare class ShopListingInventory {
    http: HttpClient;
     ...
     */
    getListingInventory: ({ listingId, ...query }: IGetListingInventoryParams, params?: RequestParams) => Promise<import("axios").AxiosResponse<IListingInventoryWithAssociations, any>>;
    /**
     ...
     * @response `500` `IErrorSchema` The server encountered an internal error. See the error message for details.
     */
    updateListingInventory: (listingId: number, data: IUpdateListingInventoryPayload, params?: RequestParams) => Promise<import("axios").AxiosResponse<IListingInventory, any>>;
}
