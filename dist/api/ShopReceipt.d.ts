import { ICreateReceiptShipmentPayload, IGetShopReceiptsParams, IShopReceipt, IShopReceipts, IUpdateShopReceiptPayload } from "./data-contracts";
import { HttpClient, RequestParams } from "./http-client";
export declare class ShopReceipt {
    http: HttpClient;
     ...
     */
    getShopReceipt: (shopId: number, receiptId: number, params?: RequestParams) => Promise<import("axios").AxiosResponse<IShopReceipt, any>>;
    /**
     ...
     * @response `500` `IErrorSchema` The server encountered an internal error. See the error message for details.
     */
    updateShopReceipt: (shopId: number, receiptId: number, data: IUpdateShopReceiptPayload, params?: RequestParams) => Promise<import("axios").AxiosResponse<IShopReceipt, any>>;
    /**
     ...
     * @response `500` `IErrorSchema` The server encountered an internal error. See the error message for details.
     */
    getShopReceipts: ({ shopId, ...query }: IGetShopReceiptsParams, params?: RequestParams) => Promise<import("axios").AxiosResponse<IShopReceipts, any>>;
    /**
     ...
     * @response `500` `IErrorSchema` The server encountered an internal error. See the error message for details.
     */
    createReceiptShipment: (shopId: number, receiptId: number, data: ICreateReceiptShipmentPayload, params?: RequestParams) => Promise<import("axios").AxiosResponse<IShopReceipt, any>>;
}
