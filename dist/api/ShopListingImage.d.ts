import { IListingImage, IListingImages, IUploadListingImagePayload } from "./data-contracts";
import { HttpClient, RequestParams } from "./http-client";
export declare class ShopListingImage {
    http: HttpClient;
     ...
     */
    deleteListingImage: (shopId: number, listingId: number, listingImageId: number, params?: RequestParams) => Promise<import("axios").AxiosResponse<void, any>>;
    /**
     ...
     * @response `500` `IErrorSchema` The server encountered an internal error. See the error message for details.
     */
    getListingImageDeprecated: (shopId: number, listingId: number, listingImageId: number, params?: RequestParams) => Promise<import("axios").AxiosResponse<IListingImage, any>>;
    /**
     ...
     * @response `500` `IErrorSchema` The server encountered an internal error. See the error message for details.
     */
    getListingImage: (listingId: number, listingImageId: number, params?: RequestParams) => Promise<import("axios").AxiosResponse<IListingImage, any>>;
    /**
     ...
     * @response `500` `IErrorSchema` The server encountered an internal error. See the error message for details.
     */
    getListingImages: (listingId: number, params?: RequestParams) => Promise<import("axios").AxiosResponse<IListingImages, any>>;
    /**
     ...
     * @response `500` `IErrorSchema` The server encountered an internal error. See the error message for details.
     */
    getListingImagesDeprecated: (shopId: number, listingId: number, params?: RequestParams) => Promise<import("axios").AxiosResponse<IListingImages, any>>;
    /**
     ...
     * @response `500` `IErrorSchema` The server encountered an internal error. See the error message for details.
     */
    uploadListingImage: (shopId: number, listingId: number, data: IUploadListingImagePayload, params?: RequestParams) => Promise<import("axios").AxiosResponse<IListingImage, any>>;
}
