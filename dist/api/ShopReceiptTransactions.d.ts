import { IGetShopReceiptTransactionsByListingParams, IGetShopReceiptTransactionsByShopParams, IShopReceiptTransaction, IShopReceiptTransactions } from "./data-contracts";
import { HttpClient, RequestParams } from "./http-client";
export declare class ShopReceiptTransactions {
    http: HttpClient;
     ...
     */
    getShopReceiptTransactionsByListing: ({ shopId, listingId, ...query }: IGetShopReceiptTransactionsByListingParams, params?: RequestParams) => Promise<import("axios").AxiosResponse<IShopReceiptTransactions, any>>;
    /**
     ...
     * @response `500` `IErrorSchema` The server encountered an internal error. See the error message for details.
     */
    getShopReceiptTransactionsByReceipt: (shopId: number, receiptId: number, params?: RequestParams) => Promise<import("axios").AxiosResponse<IShopReceiptTransactions, any>>;
    /**
     ...
     * @response `500` `IErrorSchema` The server encountered an internal error. See the error message for details.
     */
    getShopReceiptTransaction: (shopId: number, transactionId: number, params?: RequestParams) => Promise<import("axios").AxiosResponse<IShopReceiptTransaction, any>>;
    /**
     ...
     * @response `500` `IErrorSchema` The server encountered an internal error. See the error message for details.
     */
    getShopReceiptTransactionsByShop: ({ shopId, ...query }: IGetShopReceiptTransactionsByShopParams, params?: RequestParams) => Promise<import("axios").AxiosResponse<IShopReceiptTransactions, any>>;
}
