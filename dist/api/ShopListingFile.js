...
exports.ShopListingFile = void 0;
var tslib_1 = require("tslib");
var http_client_1 = require("./http-client");
var ShopListingFile = /** @class */ (function () {
    function ShopListingFile(http) {
        var _this = this;
        /**
         ...
         */
        this.deleteListingFile = function (shopId, listingId, listingFileId, params) {
            if (params === void 0) { params = {}; }
            return _this.http.request(tslib_1.__assign({ path: "/v3/application/shops/".concat(shopId, "/listings/").concat(listingId, "/files/").concat(listingFileId), method: "DELETE", secure: true }, params));
        };
        /**
         ...
         * @response `500` `IErrorSchema` The server encountered an internal error. See the error message for details.
         */
        this.getListingFile = function (shopId, listingId, listingFileId, params) {
            if (params === void 0) { params = {}; }
            return _this.http.request(tslib_1.__assign({ path: "/v3/application/shops/".concat(shopId, "/listings/").concat(listingId, "/files/").concat(listingFileId), method: "GET", secure: true, format: "json" }, params));
        };
        /**
         ...
         * @response `500` `IErrorSchema` The server encountered an internal error. See the error message for details.
         */
        this.getAllListingFiles = function (listingId, shopId, params) {
            if (params === void 0) { params = {}; }
            return _this.http.request(tslib_1.__assign({ path: "/v3/application/shops/".concat(shopId, "/listings/").concat(listingId, "/files"), method: "GET", secure: true, format: "json" }, params));
        };
        /**
         ...
         * @response `500` `IErrorSchema` The server encountered an internal error. See the error message for details.
         */
        this.uploadListingFile = function (shopId, listingId, data, params) {
            if (params === void 0) { params = {}; }
            return _this.http.request(tslib_1.__assign({ path: "/v3/application/shops/".concat(shopId, "/listings/").concat(listingId, "/files"), method: "POST", body: data, secure: true, type: http_client_1.ContentType.FormData, format: "json" }, params));
        };
        this.http = http;
    }
    return ShopListingFile;
}());
exports.ShopListingFile = ShopListingFile;
