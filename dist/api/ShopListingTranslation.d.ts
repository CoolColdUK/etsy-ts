import { ICreateListingTranslationPayload, IListingTranslation, IUpdateListingTranslationPayload } from "./data-contracts";
import { HttpClient, RequestParams } from "./http-client";
export declare class ShopListingTranslation {
    http: HttpClient;
     ...
     */
    createListingTranslation: (shopId: number, listingId: number, language: string, data: ICreateListingTranslationPayload, params?: RequestParams) => Promise<import("axios").AxiosResponse<IListingTranslation, any>>;
    /**
     ...
     * @response `500` `IErrorSchema` The server encountered an internal error. See the error message for details.
     */
    getListingTranslation: (shopId: number, listingId: number, language: string, params?: RequestParams) => Promise<import("axios").AxiosResponse<IListingTranslation, any>>;
    /**
     ...
     * @response `500` `IErrorSchema` The server encountered an internal error. See the error message for details.
     */
    updateListingTranslation: (shopId: number, listingId: number, language: string, data: IUpdateListingTranslationPayload, params?: RequestParams) => Promise<import("axios").AxiosResponse<IListingTranslation, any>>;
}
