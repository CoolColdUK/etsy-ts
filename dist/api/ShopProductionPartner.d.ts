import { IShopProductionPartners } from "./data-contracts";
import { HttpClient, RequestParams } from "./http-client";
export declare class ShopProductionPartner {
    http: HttpClient;
     ...
     */
    getShopProductionPartners: (shopId: number, params?: RequestParams) => Promise<import("axios").AxiosResponse<IShopProductionPartners, any>>;
}
