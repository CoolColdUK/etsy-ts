import { IShopListingFile, IShopListingFiles, IUploadListingFilePayload } from "./data-contracts";
import { HttpClient, RequestParams } from "./http-client";
export declare class ShopListingFile {
    http: HttpClient;
     ...
     */
    deleteListingFile: (shopId: number, listingId: number, listingFileId: number, params?: RequestParams) => Promise<import("axios").AxiosResponse<void, any>>;
    /**
     ...
     * @response `500` `IErrorSchema` The server encountered an internal error. See the error message for details.
     */
    getListingFile: (shopId: number, listingId: number, listingFileId: number, params?: RequestParams) => Promise<import("axios").AxiosResponse<IShopListingFile, any>>;
    /**
     ...
     * @response `500` `IErrorSchema` The server encountered an internal error. See the error message for details.
     */
    getAllListingFiles: (listingId: number, shopId: number, params?: RequestParams) => Promise<import("axios").AxiosResponse<IShopListingFiles, any>>;
    /**
     ...
     * @response `500` `IErrorSchema` The server encountered an internal error. See the error message for details.
     */
    uploadListingFile: (shopId: number, listingId: number, data: IUploadListingFilePayload, params?: RequestParams) => Promise<import("axios").AxiosResponse<IShopListingFile, any>>;
}
