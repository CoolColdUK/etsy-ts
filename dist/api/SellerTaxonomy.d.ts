import { ISellerTaxonomyNodes, ITaxonomyNodeProperties } from "./data-contracts";
import { HttpClient, RequestParams } from "./http-client";
export declare class SellerTaxonomy {
    http: HttpClient;
     ...
     */
    getSellerTaxonomyNodes: (params?: RequestParams) => Promise<import("axios").AxiosResponse<ISellerTaxonomyNodes, any>>;
    /**
     ...
     * @response `500` `IErrorSchema` The server encountered an internal error. See the error message for details.
     */
    getPropertiesByTaxonomyId: (taxonomyId: number, params?: RequestParams) => Promise<import("axios").AxiosResponse<ITaxonomyNodeProperties, any>>;
}
