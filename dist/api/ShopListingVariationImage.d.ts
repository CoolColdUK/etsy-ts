import { IListingVariationImages, IUpdateVariationImagesPayload } from "./data-contracts";
import { HttpClient, RequestParams } from "./http-client";
export declare class ShopListingVariationImage {
    http: HttpClient;
     ...
     */
    getListingVariationImages: (shopId: number, listingId: number, params?: RequestParams) => Promise<import("axios").AxiosResponse<IListingVariationImages, any>>;
    /**
     ...
     * @response `500` `IErrorSchema` The server encountered an internal error. See the error message for details.
     */
    updateVariationImages: (shopId: number, listingId: number, data: IUpdateVariationImagesPayload, params?: RequestParams) => Promise<import("axios").AxiosResponse<IListingVariationImages, any>>;
}
