import { IGetReviewsByListingParams, IGetReviewsByShopParams, IListingReviews, ITransactionReviews } from "./data-contracts";
...
export declare class Review {
     ...
     */
    getReviewsByListing: ({ listingId, ...query }: IGetReviewsByListingParams, params?: RequestParams) => Promise<import("axios").AxiosResponse<IListingReviews, any>>;
    /**
     ...
     * @response `500` `IErrorSchema` The server encountered an internal error. See the error message for details.
     */
    getReviewsByShop: ({ shopId, ...query }: IGetReviewsByShopParams, params?: RequestParams) => Promise<import("axios").AxiosResponse<ITransactionReviews, any>>;
}
