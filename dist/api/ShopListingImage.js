...
exports.ShopListingImage = void 0;
var tslib_1 = require("tslib");
var http_client_1 = require("./http-client");
var ShopListingImage = /** @class */ (function () {
    function ShopListingImage(http) {
        var _this = this;
        /**
         ...
         */
        this.deleteListingImage = function (shopId, listingId, listingImageId, params) {
            if (params === void 0) { params = {}; }
            return _this.http.request(tslib_1.__assign({ path: "/v3/application/shops/".concat(shopId, "/listings/").concat(listingId, "/images/").concat(listingImageId), method: "DELETE", secure: true }, params));
        };
        /**
         ...
         * @response `500` `IErrorSchema` The server encountered an internal error. See the error message for details.
         */
        this.getListingImageDeprecated = function (shopId, listingId, listingImageId, params) {
            if (params === void 0) { params = {}; }
            return _this.http.request(tslib_1.__assign({ path: "/v3/application/shops/".concat(shopId, "/listings/").concat(listingId, "/images/").concat(listingImageId), method: "GET", secure: true, format: "json" }, params));
        };
        /**
         ...
         * @response `500` `IErrorSchema` The server encountered an internal error. See the error message for details.
         */
        this.getListingImage = function (listingId, listingImageId, params) {
            if (params === void 0) { params = {}; }
            return _this.http.request(tslib_1.__assign({ path: "/v3/application/listings/".concat(listingId, "/images/").concat(listingImageId), method: "GET", secure: true, format: "json" }, params));
        };
        /**
         ...
         * @response `500` `IErrorSchema` The server encountered an internal error. See the error message for details.
         */
        this.getListingImages = function (listingId, params) {
            if (params === void 0) { params = {}; }
            return _this.http.request(tslib_1.__assign({ path: "/v3/application/listings/".concat(listingId, "/images"), method: "GET", secure: true, format: "json" }, params));
        };
        /**
         ...
         * @response `500` `IErrorSchema` The server encountered an internal error. See the error message for details.
         */
        this.getListingImagesDeprecated = function (shopId, listingId, params) {
            if (params === void 0) { params = {}; }
            return _this.http.request(tslib_1.__assign({ path: "/v3/application/shops/".concat(shopId, "/listings/").concat(listingId, "/images"), method: "GET", secure: true, format: "json" }, params));
        };
        /**
         ...
         * @response `500` `IErrorSchema` The server encountered an internal error. See the error message for details.
         */
        this.uploadListingImage = function (shopId, listingId, data, params) {
            if (params === void 0) { params = {}; }
            return _this.http.request(tslib_1.__assign({ path: "/v3/application/shops/".concat(shopId, "/listings/").concat(listingId, "/images"), method: "POST", body: data, secure: true, type: http_client_1.ContentType.FormData, format: "json" }, params));
        };
        this.http = http;
    }
    return ShopListingImage;
}());
exports.ShopListingImage = ShopListingImage;
