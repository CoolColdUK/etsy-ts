...
var Other = /** @class */ (function () {
    function Other(http) {
        ...
        this.ping = function (params) {
            ...
            return _this.http.request(tslib_1.__assign({ path: "/v3/application/openapi-ping", method: "GET", secure: true, format: "json" }, params));
        };
        /**
         ...
         * @response `500` `IErrorSchema` The server encountered an internal error. See the error message for details.
         */
        this.tokenScopes = function (data, params) {
            if (params === void 0) { params = {}; }
            return _this.http.request(tslib_1.__assign({ path: "/v3/application/scopes", method: "POST", body: data, secure: true, type: http_client_1.ContentType.UrlEncoded, format: "json" }, params));
        };
        this.http = http;
    }
    return Other;
