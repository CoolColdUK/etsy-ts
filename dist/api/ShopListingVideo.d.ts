import { IListingVideo, IListingVideos, IUploadListingVideoPayload } from "./data-contracts";
import { HttpClient, RequestParams } from "./http-client";
export declare class ShopListingVideo {
    http: HttpClient;
     ...
     */
    deleteListingVideo: (shopId: number, listingId: number, videoId: number, params?: RequestParams) => Promise<import("axios").AxiosResponse<void, any>>;
    /**
     ...
     * @response `500` `IErrorSchema` The server encountered an internal error. See the error message for details.
     */
    getListingVideo: (videoId: number, listingId: number, params?: RequestParams) => Promise<import("axios").AxiosResponse<IListingVideo, any>>;
    /**
     ...
     * @response `500` `IErrorSchema` The server encountered an internal error. See the error message for details.
     */
    getListingVideos: (listingId: number, params?: RequestParams) => Promise<import("axios").AxiosResponse<IListingVideos, any>>;
    /**
     ...
     * @response `500` `IErrorSchema` The server encountered an internal error. See the error message for details.
     */
    uploadListingVideo: (shopId: number, listingId: number, data: IUploadListingVideoPayload, params?: RequestParams) => Promise<import("axios").AxiosResponse<IListingVideo, any>>;
}
