import { IGetShopPaymentAccountLedgerEntriesParams, IPaymentAccountLedgerEntries, IPaymentAccountLedgerEntry } from "./data-contracts";
...
export declare class LedgerEntry {
     ...
     */
    getShopPaymentAccountLedgerEntry: (shopId: number, ledgerEntryId: number, params?: RequestParams) => Promise<import("axios").AxiosResponse<IPaymentAccountLedgerEntry, any>>;
    /**
     ...
     * @response `500` `IErrorSchema` The server encountered an internal error. See the error message for details.
     */
    getShopPaymentAccountLedgerEntries: ({ shopId, ...query }: IGetShopPaymentAccountLedgerEntriesParams, params?: RequestParams) => Promise<import("axios").AxiosResponse<IPaymentAccountLedgerEntries, any>>;
}
