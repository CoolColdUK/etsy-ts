...
exports.SellerTaxonomy = void 0;
var tslib_1 = require("tslib");
var SellerTaxonomy = /** @class */ (function () {
    function SellerTaxonomy(http) {
        var _this = this;
        /**
         ...
         */
        this.getSellerTaxonomyNodes = function (params) {
            if (params === void 0) { params = {}; }
            return _this.http.request(tslib_1.__assign({ path: "/v3/application/seller-taxonomy/nodes", method: "GET", secure: true, format: "json" }, params));
        };
        /**
         ...
         * @response `500` `IErrorSchema` The server encountered an internal error. See the error message for details.
         */
        this.getPropertiesByTaxonomyId = function (taxonomyId, params) {
            if (params === void 0) { params = {}; }
            return _this.http.request(tslib_1.__assign({ path: "/v3/application/seller-taxonomy/nodes/".concat(taxonomyId, "/properties"), method: "GET", secure: true, format: "json" }, params));
        };
        this.http = http;
    }
    return SellerTaxonomy;
}());
exports.SellerTaxonomy = SellerTaxonomy;
