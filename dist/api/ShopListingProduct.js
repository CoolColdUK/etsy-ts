...
exports.ShopListingProduct = void 0;
var tslib_1 = require("tslib");
var ShopListingProduct = /** @class */ (function () {
    function ShopListingProduct(http) {
        var _this = this;
        /**
         ...
         */
        this.getListingProduct = function (listingId, productId, params) {
            if (params === void 0) { params = {}; }
            return _this.http.request(tslib_1.__assign({ path: "/v3/application/listings/".concat(listingId, "/inventory/products/").concat(productId), method: "GET", secure: true, format: "json" }, params));
        };
        this.http = http;
    }
    return ShopListingProduct;
}());
exports.ShopListingProduct = ShopListingProduct;
